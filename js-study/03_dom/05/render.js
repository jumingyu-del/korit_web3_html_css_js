...
const renderPagination = () => {
    ...
    if(endPage > totalPage) {
        // 현재페이지가 100페이지
        // 102페이지까지 렌더링 됨
        // 근데 최대페이지가 101페이지면, 102페이지는 잘못 렌더링
